...
export const CITIES: City[] = [
  ...
  /* ── August 2026 line-up ── */
  {
    ...
    rating: "UA",
    duration: "2h 47m",
    poster: tmdb("/aA8JdaESgCHDuCUmBLBPFTgGPeV.jpg"),
    cities: ALL,
  ...
  },
  {
    ...
    rating: "UA",
    duration: "2h 52m",
    poster: tmdb("/vXg9ybBNMUbOlLMJpKqy4vA6HPC.jpg"),
    cities: ALL,
  ...
  },
  {
    ...
    rating: "A",
    duration: "2h 18m",
    poster: "https://placehold.co/300x450/1a1a2e/ffffff?text=Awarapan+2",
    cities: ALL,
    times: T3,
  },
  {
    ...
    rating: "UA",
    duration: "2h 34m",
    poster: "https://placehold.co/300x450/2d1b0e/ffffff?text=Batwara+1947",
    cities: ALL,
    times: T4,
  },
  {
  ...
  /* Tamil */
  {
    ...
    rating: "UA",
    duration: "2h 39m",
    poster: tmdb("/bHHCIJGKS0SJlSHfTgGVuCe8JR5.jpg"),
  ...
  },
  {
    ...
    rating: "UA",
    duration: "2h 21m",
    poster: "https://placehold.co/300x450/1a0a0a/ffffff?text=DC",
    cities: ["chennai", "bengaluru", "hyderabad", "mumbai", "delhi"],
    times: T3,
  },
  {
    ...
    rating: "UA",
    duration: "2h 12m",
    poster: "https://placehold.co/300x450/0d1f0d/ffffff?text=Gatta+Kusthi+2",
    cities: ["chennai", "bengaluru", "hyderabad", "mumbai", "delhi"],
    times: T4,
  },
  {
  ...
  /* Telugu */
  {
    ...
    rating: "U",
    duration: "2h 28m",
    poster: tmdb("/kYeHcXO6sQYYhGSKx2R3uLvFuNM.jpg"),
  ...
  /* Malayalam */
  {
    ...
    rating: "UA",
    duration: "2h 11m",
    poster: "https://placehold.co/300x450/0a1a2a/ffffff?text=Thudakkam",
  ...
  /* Kannada */
  {
    ...
    rating: "A",
    duration: "2h 47m",
    poster: tmdb("/xGjAiLQXJXrRHKXSHYHo4tPJUMV.jpg"),
    cities: ALL,
  ...
  /* Hollywood */
  {
    ...
    rating: "UA",
    duration: "2h 16m",
    poster: ph("The End of Oak Street"),
    cities: ALL,
    times: T2,
  },
  {
...
export const MOVIES: Movie[] = [
  {
    ...
    rating: "UA",
    duration: "2h 21m",
    poster: tmdb("/rHmSHODKHjMsLDRbUFDWWMPSyMJ.jpg"),
    cities: ALL,
    dubbed: ["hyderabad", "chennai", "kochi", "bengaluru"],
    times: T1,
  },
  {
    ...
    rating: "U",
    duration: "1h 41m",
    poster: tmdb("/iPPTGh4Kp6UoMhBqFHsoaw1rkNL.jpg"),
    cities: ALL,
  ...
  },
  {
    ...
    rating: "UA",
    duration: "2h 07m",
    poster: tmdb("/m9EtP1WBPDwMR1MsN3bZ42kSQVs.jpg"),
    cities: ALL,
    dubbed: ["hyderabad", "chennai"],
    times: T2,
  },
  {
    ...
    rating: "UA",
    duration: "3h 15m",
    poster: tmdb("/1nMgWno07HNBMfBNBqGnlYELzz3.jpg"),
    cities: ALL,
  ...
  },
  {
    ...
    rating: "UA",
    duration: "2h 09m",
    poster: tmdb("/pCfuKImQgA0oqNpMc5h1jWXOEUH.jpg"),
    cities: ALL,
  ...
  },
  {
    ...
    rating: "UA",
    duration: "2h 14m",
    poster: tmdb("/oEtFb3x0gJSiJTAhSQMWEEGi2Sm.jpg"),
    cities: ALL,
    dubbed: ["bengaluru", "chennai", "hyderabad"],
    times: T2,
  },
  ...
  },
  {
    ...
    rating: "U",
    duration: "1h 58m",
    poster: tmdb("/9ypNNjBqV2nfPLKPLVa89BzTr2b.jpg"),
    cities: ALL,
    dubbed: ["hyderabad", "chennai", "kochi", "bengaluru"],
